...
public class MSDMainClient {
    public static void init() {
        ...
        RegistryClient.registerTileEntityRenderer(MSDBlockEntityTypes.STANDING_SIGN_1_TILE_ENTITY.get(), dispatcher -> new RenderCustomTextSign<>(dispatcher, 1, 2.5F, 7.25F, 7.64F, 4F, 11, true, 0xA78E44, false, 0xA78E44, 1.6F, 1.6F, 3.2F, 0.0625F));
