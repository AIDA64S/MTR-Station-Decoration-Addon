...
public class BlockYamanote7PIDS  extends BlockPIDSBase {
    @Override
    ...
    public void appendHoverText(ItemStack itemStack, BlockGetter blockGetter, List<Component> list, TooltipFlag tooltipFlag) {
        list.add(Text.translatable("tooltip.msd.yamanote_7_pids_length").setStyle(Style.EMPTY.withColor(ChatFormatting.GRAY)));
    }
