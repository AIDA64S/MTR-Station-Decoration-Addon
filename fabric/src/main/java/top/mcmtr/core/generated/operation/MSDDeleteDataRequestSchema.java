...
public abstract class MSDDeleteDataRequestSchema implements SerializedDataBase {
    ...
    protected MSDDeleteDataRequestSchema() {
    }

    protected MSDDeleteDataRequestSchema(ReaderBase readerBase) {
    }
