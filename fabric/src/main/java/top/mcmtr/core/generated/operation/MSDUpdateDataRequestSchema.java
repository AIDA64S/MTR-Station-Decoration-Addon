...
public abstract class MSDUpdateDataRequestSchema implements SerializedDataBase {
    ...
    protected MSDUpdateDataRequestSchema() {
    }

    protected MSDUpdateDataRequestSchema(ReaderBase readerBase) {
    }
